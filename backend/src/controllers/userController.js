...
const getMe = async (req, res) => {
  try {
    // Super Admin has no DB row in users
...
// ─────────────────────────────────────────────────────────────────────────────
// POST /api/users/me/photo — Upload foto profil ke DB sebagai BLOB
// ─────────────────────────────────────────────────────────────────────────────
const uploadPhoto = async (req, res) => {
  try {
    ...
    const photoUrl  = `/api/images/users/${req.user.id}`;

    await pool.query(
      'UPDATE users SET photo = ?, avatar = ?, photo_data = ?, photo_type = ? WHERE id = ?',
      [photoUrl, photoUrl, photoData, photoType, req.user.id]
    );
...
// ─────────────────────────────────────────────────────────────────────────────
// POST /api/users/:id/reject  (Admin & Super Admin)
// ─────────────────────────────────────────────────────────────────────────────
