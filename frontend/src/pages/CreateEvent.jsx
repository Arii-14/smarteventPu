          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-h-64 overflow-y-auto pr-1">
              {filteredSpeakers.map(spk => {
                ...
                return (
                  ...
                  >
                    <img
                      src={spk.photo ? `${import.meta.env.PROD ? '' : 'http://localhost:5000'}${spk.photo.startsWith('/') ? '' : '/'}${spk.photo}` : `https://ui-avatars.com/api/?name=${encodeURIComponent(spk.name)}&background=6366f1&color=fff&size=40`}
                      alt={spk.name}
